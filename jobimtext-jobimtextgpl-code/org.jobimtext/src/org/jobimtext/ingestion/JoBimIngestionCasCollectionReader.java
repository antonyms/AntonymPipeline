...
/**
 * The collection reader is used to process a set of CASs in Xmi format. It determines the
 * number of files and creates a work item for each one with a corresponding
 * number of threads per file.
 * 
 * @author: mchowdh
 */
public class JoBimIngestionCasCollectionReader extends CollectionReader_ImplBase {

	// UIMA input parameters
	public final static String LANGUAGE_CODE = "en";
	public final static String INPUT_PATH_PARAM = "InputPath";
	public final static String FILE_PATTERN_PARAM = "xmi";

	public final static String CAS_ANALYSES_ENGINE_DESCRIPTOR = "CasTypeDescriptor"; 
	...
	public synchronized void getNext(CAS cas) throws IOException,
		...
		if (index % 1000 == 0)
			logger.log(Level.INFO, "CR:next:index=" + index + ":file=" + fileName);
		else
			logger.log(Level.FINE, "CR:next:index=" + index + ":file=" + fileName);
	...
	public void initialize() throws ResourceInitializationException {
		...
		// get the input files
		String filePattern = FILE_PATTERN_PARAM;

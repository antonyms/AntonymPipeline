 ...
 ** 
 ** Additionally, this version includes the parameters s and t from the output of
 * "FreqSigWithT"
 ** 
 ** @author Richard Steuer
 ** 
 **/
public class AggrPerFtWithParams {

 ...
 *
 */
public class SynHeadOfTerm extends OrigTextNormTextHeadFreq {
	
	public SynHeadOfTerm() {
	 ...
	 * @param pos
	 */
	public static void addItemInCollection ( Map<String, SynHeadOfTerm> mapKeysWithFreq, String key, String lemma, String origText, String head, int f, String pos ) {

		SynHeadOfTerm objNormMweFreq = mapKeysWithFreq.get(key.toLowerCase());
		if ( objNormMweFreq == null )
			objNormMweFreq = new SynHeadOfTerm();

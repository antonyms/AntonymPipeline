...
public class Dependency_Type extends Annotation_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("org.jobimtext.holing.type.Dependency");
  ...
  public int getGovernor(int addr) {
      ...
      jcas.throwFeatMissing("Governor", "org.jobimtext.holing.type.Dependency");
  ...
  public int getDependent(int addr) {
      ...
      jcas.throwFeatMissing("Dependent", "org.jobimtext.holing.type.Dependency");
  ...
  public String getDependencyType(int addr) {
      ...
      jcas.throwFeatMissing("DependencyType", "org.jobimtext.holing.type.Dependency");
  ...
  public Dependency_Type(JCas jcas, Type casType) {
    ...
    casFeat_Governor = jcas.getRequiredFeatureDE(casType, "Governor", "org.jobimtext.holing.type.Token", featOkTst);
    casFeatCode_Governor  = (null == casFeat_Governor) ? JCas.INVALID_FEATURE_CODE : ((FeatureImpl)casFeat_Governor).getCode();

 
    casFeat_Dependent = jcas.getRequiredFeatureDE(casType, "Dependent", "org.jobimtext.holing.type.Token", featOkTst);

...
public abstract class HolingOutputIndexed extends JCasAnnotator_ImplBase {
	...
	public void initialize(UimaContext context)
		...
		try {
			System.out.println(extractorConfFileName);
	...
	public void process(JCas aJCas) throws AnalysisEngineProcessException {
		synchronized (this) {
			...
			for (JoBim jobim : select(aJCas, JoBim.class)) {
				String filename = unitId+"_"+jobim.getRelation();

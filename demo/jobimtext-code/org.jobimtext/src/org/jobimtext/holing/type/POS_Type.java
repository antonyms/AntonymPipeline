...
public class POS_Type extends Annotation_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("org.jobimtext.holing.type.POS");
  ...
  public String getPosValue(int addr) {
      ...
      jcas.throwFeatMissing("PosValue", "org.jobimtext.holing.type.POS");

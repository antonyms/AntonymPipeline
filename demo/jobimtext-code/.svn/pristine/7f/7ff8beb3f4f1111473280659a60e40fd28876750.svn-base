 ...
 *
 */
public class NormalizedTerm extends OrigTextNormTextHeadFreq {
	 ...
	 * @param pos
	 */
	public static void addItemInCollection ( Map<String, NormalizedTerm> mapKeysWithFreq, String key, String lemma, 
			String origText, String head, int f, String pos, String posOfFirstTok  ) {

		NormalizedTerm objNormMweFreq = mapKeysWithFreq.get(key.toLowerCase());
		if ( objNormMweFreq == null )
			objNormMweFreq = new NormalizedTerm();
